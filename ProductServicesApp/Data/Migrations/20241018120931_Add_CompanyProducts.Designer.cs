...
namespace ProductServicesApp.Migrations
{
    ...
    [Migration("20241018120931_Add_CompanyProducts")]
    partial class Add_CompanyProducts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductServicesApp.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProductServicesApp.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductServicesApp.Models.CompanyProduct", b =>
                {
                    ...
                    b.HasOne("ProductServicesApp.Models.Product", "Product")
                        .WithMany("CompanyProducts")
